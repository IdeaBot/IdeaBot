...
create_messages = ['{bot-mention} plumb private pipe "Yo mama"', '{bot-mention} create private pipe Yo']
authorize_messages = ['{bot-mention} authorize {maintainer-mention} for pipe "test pipe"']
modify_messages = ['{bot-mention} add this to pipe "test pipe"', '{bot-mention} add {channel-mention} to pipe "test pipe"']
